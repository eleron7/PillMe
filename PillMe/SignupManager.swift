...
class SignupManager {
    static let signupManager = SignupManager()
    var run = true
    //생성자
    init() {
    }
    ...
    //회원정보를 추가하는 함수
    func signup(userID: String, userPW: String, userNAME: String, userTEL: String){
        var query = "INSERT INTO member values('"+userID+"', '"+userPW+"', '"+userNAME+"', '"+userTEL+"')"
