...
class SelectTimeManager {
    static let selectTimeManager = SelectTimeManager()
    ...
    //해당 약통에 등록된 시간을 반환하는 연산
    func getPillTime(moduleNum: String) -> [pillTimeModel]
    {
        var query = "SELECT * FROM PillTime WHERE ModuleNum = '"+moduleNum+"'"
