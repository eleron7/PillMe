...
class AddPillManager {
    ...
    //약 정보를 추가하는 함수
    func addPillInfo(modulenum: String, pillMaster: String, pillname: String, times: String, eat: String ){
        var query = "INSERT INTO PillList values('"+modulenum+"', '"+pillMaster+"', '"+pillname+"', '0', '"+times+"', '"+eat+"')"
